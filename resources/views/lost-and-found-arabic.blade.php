...
<html lang="en">
  <head>
    ...
    <title>Losting & Founding</title>
  </head>
  <body>
    <nav class="navbar navbar-expand-lg best position-absolute w-100 top-0">
        <div class="container-fluid">
          <a class="navbar-brand text-white lang mx-3 ms-5" href="lost-and-found" ><i class="fa-solid fa-earth-americas"></i>EN</a >
          <button
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav m-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link mx-3 text-white " href="cars"
                  ><i class="fa-solid fa-car"></i> السيارات</a
                >
              </li>
              <li class="nav-item">
                <a class="nav-link mx-3 text-white  active " href="lost-and-found"
        ...
        <main>
          <section>
            <form class="form-control my-bg" action="{{ route('/form3') }}" method="POST"  enctype="multipart/form-data">
              @csrf
